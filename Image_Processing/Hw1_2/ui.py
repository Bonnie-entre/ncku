...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Button2_3.setGeometry(QtCore.QRect(460, 240, 222, 34))
        ...
        self.Button2_4.setGeometry(QtCore.QRect(460, 320, 222, 34))
    ...
    def retranslateUi(self, Form):
        ...
        self.Button11_1.setText(_translate("Form", "3.1 Gaussian Blur"))
        self.Button11_2.setText(_translate("Form", "3.2 Sobel X"))
        self.Button11_3.setText(_translate("Form", "3.3 Sobel Y"))
        self.Button11_4.setText(_translate("Form", "3.4 Magnitude"))
        self.Button2_2.setText(_translate("Form", "4.2 Translation"))
        self.Button2_3.setText(_translate("Form", "4.3 Rotation, Scaling"))
        self.Button2_4.setText(_translate("Form", "4.4 Shearing"))
        self.Button2_1.setText(_translate("Form", "4.1 Resize"))
        ...
        self.groupBox_2.setTitle(_translate("Form", "4. Transformation"))
